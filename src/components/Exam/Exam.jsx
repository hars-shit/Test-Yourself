...
const Exam = () => {
  ...
  const getResponse = async () => {
    ...
    try {
      setLoading(true);
      const message = `Give me 15 random  mcq questions hard nad medium on the topic ${topic} in json format without any extra text only json file. The first entity will be the question, then the correct answer index ,index will be start from 0, and then the 4 options which also include the correct answer 
      example:
      [
        {
