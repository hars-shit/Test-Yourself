...
const Paper = () => {
  ...
  const topic = useSelector((state) => state.paperSlice);
  ...
  return (
    ...
    {/* Quiz Header */}
    <div className="flex flex-col md:flex-row justify-between w-full md:mb-10 px-8">
        <div className="flex flex-col justify-center items-center mb-4 text-gray-400">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Autoprob</h1>
    ...
    <div className="flex justify-center w-full    md:w-[80vw] py-8 px-6 md:px-12" style={{boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px'}}>
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center w-full">
            ...
            <div className="flex flex-col justify-center items-center w-full md:w-3/5 p-6 ">
                {index < data.length && (
                    <div className="mb-6 w-full">
                        ...
                        <form className="space-y-4 w-full pt-8">
            ...
            {/* calender  */}
            <div className="w-full md:w-2/5 flex flex-col pt-8 justify-center items-center mt-4 md:mt-0">
                
                <div className="grid  grid-cols-4 gap-4 p-8 bg-white rounded-md shadow-md">
